...
const system_prompt = `You are an helpfull AI Assistant who is specialized in resolving user query.
    ...
    Output: {{ "step": "start", "content": "The user is interseted in weather data of new york" }}
...
app.get('/chat', async (req, res) => {
  ...
  const completion = await openai.chat.completions.create({
    ...
    messages: [
      ...
      { role: "assistant", content: JSON.stringify("{ \"step\": \"start\", \"content\": \"The user is interested in weather data of Kolkata.\" }") },
